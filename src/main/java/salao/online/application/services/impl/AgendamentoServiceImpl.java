...
public class AgendamentoServiceImpl implements AgendamentoService {
    ...
    @Override
    public List<AgendamentoDTO> buscarAgendamentosDoProfissional(UUID idProfissional, LocalDate data,
    ...
    @Override
    public List<AgendamentoDTO> buscarAgendamentosDoCliente(UUID idCliente, LocalDate data,
            StatusAgendamentoEnum status, FormaPagamentoEnum formaPagamento) {
